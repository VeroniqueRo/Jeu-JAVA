    ...
    public static void main(String[] args) {
        ...
        int nbPerso = 0;
            ...
            if (str.equals("1")) {
                ...
                guerrier1.setNom(creationNom()); // Attribuer le nom donné par l'utilisateur au Guerrier créée
                    ...
                    //     guerrier1.setNom(nomPerso);
                    // }

                //************************ Donner une image au personnage ****************************************
                System.out.println("Quelle image souhaitez-vous ?");
                String nomImage = sc.nextLine();
                guerrier1.setImage(nomImage); // Attribuer une image donnée par l'utilisateur au Guerrier créé
